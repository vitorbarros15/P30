...
describe('Job DTOs', () => {
  describe('CreateJobDto', () => {
    ...
    it('should validate a valid create job DTO', async () => {
      const dto = plainToClass(CreateJobDto, validCreateJobDto);
    ...
    it('should fail validation with empty title', async () => {
      ...
      const dto = plainToClass(CreateJobDto, invalidDto);
      const errors = await validate(dto);
    ...
    it('should fail validation with missing required fields', async () => {
      ...
      expect(errors).toHaveLength(5); // title, description, location, salaryRange, skills
    });
  });
  ...
  describe('UpdateJobDto', () => {
    it('should validate with partial data', async () => {
      ...
      const dto = plainToClass(UpdateJobDto, updateDto);
      const errors = await validate(dto);
    ...
    it('should inherit validation rules from CreateJobDto', async () => {
      ...
      const dto = plainToClass(UpdateJobDto, invalidDto);
      const errors = await validate(dto);
  ...
  describe('JobQueryDto', () => {
    it('should validate a valid query DTO', async () => {
      ...
      const dto = plainToClass(JobQueryDto, queryDto);
      const errors = await validate(dto);
    ...
    it('should fail validation with invalid page number', async () => {
      ...
      const dto = plainToClass(JobQueryDto, invalidDto);
      const errors = await validate(dto);
